...
if __name__ == '__main__':
    ...
    arch_single_list = []
    arch_single = ['ui_mat_mat_multiply_i']
    # arch_dict = {'cf': 'ui', 'emb':{'u': 'ngcf', 'i': 'ngcf'}, 'ifc': 'mul', 'pred': 'i'}

    arch_dict = {'cf': 'ui', 'emb':{'u': 'lightgcn', 'i': 'lightgcn'}, 'ifc': 'mul', 'pred': 'i'}
    arch_single_list.append(arch_dict)
    ...
    avaliable_device_ids = [6] # rtx3090
